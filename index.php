<?php
    ...
    $data=[
        ...
        [
            ...
            'risposta' => "<p>We know security and privacy are important to you – and they are important to us, too. We make it a priority to provide strong security and give you confidence that your information is safe and accessible when you need it.</p>
        ...
        [
            ...
            'risposta' => "<p>Your account is associated with a country (or territory) in the Terms of Service so that we can determine two things:</p>
            <ol>
        ...
        [
            'domanda' => 'Determining the country associated with your account',
            'risposta' => "<p>When you create a new account, we associate your account with a country based on where you created your Google Account. For accounts at least a year old, we use the country from which you usually access Google services — typically where you’ve spent the most time in the last year. </p>
...
<html lang="en">
    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 header fixed-top p-0">
                    <div class="top d-flex p-3 pb-0 w-100">
                        <div class="left">
                    ...
                    <nav>
                        <ul>
                            ...
                            <li class="active"><a href="#" class="text-primary">FAQ</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-8 mx-auto p-3 mt-5 pt-5">
                <?php
                    foreach($data as $content){
                        echo "<h4>" . $content['domanda'] . "</h4>";
